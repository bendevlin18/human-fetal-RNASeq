...
ui <- f7Page(title="Human Fetal-Seq Mobile",
             options=list(theme = "light", skin="ios"),
             f7TabLayout(
               panels=tagList(
               ...
               f7Tabs(
                 ...
                 f7Tab(tabName="Correlation Plots", active=FALSE, icon=f7Icon('layers'),
                       column(width=4,
                              withSpinner(plotlyOutput('br_corr_plots')))),
                 f7Tab(tabName="Sex Differences", active=FALSE, icon=f7Icon('graph_square', lib='ios'),
                       column(width=4,
                              withSpinner(plotlyOutput('sex_diff')))),
                 f7Tab(tabName="Data Table", active=FALSE, icon=f7Icon('layers'),
                       column(width=4,
                              withSpinner(plotlyOutput('br_data_table'))))
